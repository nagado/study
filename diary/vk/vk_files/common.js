...
function handlePageParams(params) {
  ...
  var lnks = ['friends', 'albums' + vk.id, 'video', '', 'notes', 'groups', 'events', 'gifts.php?act=wishlist', 'apps', 'ads?act=office&last=1', 'feed' + (ge('l_nwsf') ? '?section=notifications' : ''), 'pages', 'docs'];
  var adds = ['', 'act=added', 'section=tagged', '', 'act=comments', '', 'tab=invitations', '', '', '', ge('l_nwsf') ? '' : 'section=notifications'];
