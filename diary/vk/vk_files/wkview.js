...
<div id="wk_left" style="'+hideLeft+'" class="wk_left no_select"></div>\
...
wallAfterInitPost: function () {
  ...
  if (rf) {
    placeholderSetup(rf, {pad: {margin: 0, padding: 0}})
  }
...
likesInit: function () {
  ...
  extend(wkcur, {
    ...
    lSTL: wkLayerWrap.appendChild(ce('div', {id: 'layer_stl', innerHTML: '<div id="layer_stl_bg" class="fixed"></div><div id="layer_stl_cl"></div><nobr id="layer_stl_text" class="fixed">' + getLang('global_to_top') + '</nobr>', el: ge('wk_box'), onclick: cancelEvent, onmousedown: WkView.likesSTLDown, sc: WkView.likesOnScroll})),
    lSTLShown: 0,
    lSTLWas: 0,
    lSTLWasSet: 0
  });
