...
def findAvatar():
    ...
    if '<img class="avatar"' in doc[2]:
        ...
        avatar = '<img src="../../../.extras/ava.jpg" height=100px; align="left"></img>'
    ...
    if '<tr><td colspan="3"><a name=' in trash:
        ...
        for i in range(len(comms)/6+1):
            ...
            if '<img class="avatar"' in comms[n2]:
                ...
                avatar = '<img src="../../../.extras/ava.jpg" height=50px; align="left"></img>'
...
def loadExtras():
    if not os.path.exists("Diary/.extras"):
        os.makedirs("Diary/.extras")
    if not os.path.exists("Diary/.extras/ava.jpg"):
        urllib.urlretrieve("http://cs5298.userapi.com/g32561651/a_ea42f7ac.jpg", "Diary/.extras/ava.jpg")
