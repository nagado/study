...
function reply(topic_id, div_id, form_action,redir_uri,global_topic_id,global_blog_topic_id,show_radio_buttons, global_blog_id){
...
function GetNewComments(resp){
	...
	var data = 'tid='+current_topic_id+'&lcid='+last_comment_id+(is_photo==1?'&photo=1': (is_duel ? '&duel=1' : '') )+'&adc='+(ad_counter?ad_counter:0);
	var ajax = new Ajax();
